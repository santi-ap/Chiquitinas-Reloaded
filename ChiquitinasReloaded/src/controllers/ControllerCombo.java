...
public class ControllerCombo extends ControllerFactory implements Colleague {
    ...
    /**
     * @marco Método crea un combo nuevo desde cero. Lo ampliaré para colocar
     * una fecha fin.
     */
    ...
    /**
     * @Marco Creacion de un submenu para modificar el combo
     */
    ...
    /**
     * @marco Modifica toda la información del producto
     */
            ...
            switch (respuestaUsuario) {
                ...
                case 1:
                    ...
                    if (confirmarCambio == 1) {
                        ...
                        servicioCombo.update("nombreCombo", nombreDelCombo, "idCombo", idCombo);
                    } else {
                        condicionSalida = false;
                    }
                ...
                case 2:
                    ...
                    if (confirmarCambio1 == 1) {
                        servicioCombo.update("precioClienteCombo", precioDelCombo, "idCombo", idCombo);
                    } else {
                        condicionSalida = false;
                    }
                ...
                case 3:
                    ...
                    if (confirmarCambio2 == 1) {
                        servicioCombo.update("idCombo", idDelCombo, "idCombo", idCombo);
                    } else {
                        condicionSalida = false;
                    }
                ...
                case 4:
                    ...
                    if (confirmarCambio3 == 1) {
                        servicioCombo.update("contadorProductoCombo", stockCombo, "idCombo", idCombo);
                    } else {
                        condicionSalida = false;
                    }
                ...
                case 5:
                    ...
                    if (confirmarCambio4 == 1) {
                        servicioCombo.update("descuentoCombo", conversionDescuentoCombo, "idCombo", idCombo);
                    } else {
                        condicionSalida = false;
                    }
                    ...
                    if (opcionFecha == 1) {
                        ...
                        try {
                            ...
                            if (confirmarCambio6 == 1) {
                                servicioCombo.update("fechaInicioCombo", sqlDate1, "idCombo", idCombo);
                            } else {
                                condicionSalida = false;
                            }
                            System.out.println("Desea continuar modificando este combo?\n1-Si\n2-No");
    ...
    /**
     * @marco Submenú para ver los combos
     */
    ...
    /**
     *
     * @marco Actualiza el precio del producto y es parte del menu combos
     */
    ...
    /**
     * @santi Muestra los combos y los productos dentro de esos combos
     */
    ...
    /**
     * @marco Despliega toda la información del combo selecionado
     */
